...
const projects = [
  {
    ...
    description: 'Creative Portrait for brand visibility — increased social engagement by 200%',
    image: photoFire,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Lifestyle content for brand storytelling — generated 50K+ impressions',
    image: photoGarden,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Luxury personal branding — positioned client as premium authority',
    image: photoThrone,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Travel content marketing — enhanced brand storytelling reach',
    image: photoCafe1,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Executive branding — professional corporate image delivery',
    image: photoCafe2,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Authentic storytelling content — viral social reach achieved',
    image: photoNature,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Cultural elegance portrait — 100K+ organic reach achieved',
    image: photoLights,
    tags: ['Night', 'Portrait'],
    featured: true,
  },
  {
    ...
    category: 'Photography',
    description: 'Premium outdoor branding — high-value client positioning',
    image: photoHorse,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Cultural street photography — authentic brand voice creation',
    image: photoStreet,
  ...
  },
  {
    ...
    category: 'Web',
    description: 'Full web development for host recruitment — 300+ hosts onboarded',
  ...
  },
  {
    ...
    category: 'Branding',
    description: 'Complete visual identity — achieved international agency recognition',
  ...
  },
  {
    ...
    category: 'Video',
    description: 'Promotional video production — 500K+ video views generated',
