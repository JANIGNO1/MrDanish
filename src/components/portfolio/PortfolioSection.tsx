...
const projects = [
  {
    ...
    description: 'Dramatic fire photography with artistic composition and professional lighting',
    image: photoFire,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Natural golden hour photography in beautiful garden setting',
    image: photoGarden,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Luxurious fantasy-themed portrait with floral decorations',
    image: photoThrone,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Professional lifestyle photography in scenic mountain location',
    image: photoCafe1,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Natural business casual photography with mountain backdrop',
    image: photoCafe2,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Peaceful natural photography with serene forest setting',
    image: photoNature,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Beautiful bokeh lighting with traditional elegant attire',
    image: photoLights,
    tags: ['Night', 'Portrait'],
    featured: true,
  },
  {
    ...
    category: 'Photography',
    description: 'Professional horse riding photography in natural setting',
    image: photoHorse,
  ...
  },
  {
    ...
    category: 'Photography',
    description: 'Authentic street photography with traditional cultural elements',
    image: photoStreet,
  ...
  },
  {
    ...
    category: 'Web',
    description: 'Modern landing page for international host recruitment',
  ...
  },
  {
    ...
    category: 'Branding',
    description: 'Complete branding package including logo and social assets',
  ...
  },
  {
    ...
    category: 'Video',
    description: 'Dynamic promotional video for live streaming app',
